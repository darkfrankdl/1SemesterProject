...
public class JUnitTest {
	...
	// Tester om den �nskede employee bliver f�jet til ordren under oprettelsen af denne.
	@Test
	...
	// Tester om den �nskede customer bliver f�jet til ordren korrekt.
	@Test
	void customerTest() {
	...
	// Tester de forskellige gr�nsev�rdier omkring stock for et specifikt produkt, samt om det bliver tilf�jet som forventet. 
	@Test
	void productTest() {
